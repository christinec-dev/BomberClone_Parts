...
# Game music array (for in-level music)
var game_music_tracks = [
	preload("res://Assets/music_sfx/game_music_01.mp3"),
	preload("res://Assets/music_sfx/game_music_02.mp3"),
	preload("res://Assets/music_sfx/game_music_03.mp3")
]
...
# Randomly select & play a music track on level load
func randomize_game_music():
	rng.randomize()
	var random_index = rng.randi() % game_music_tracks.size()
	var random_music_track = game_music_tracks[random_index]
	game_music.stream = random_music_track
	game_music.play()	
